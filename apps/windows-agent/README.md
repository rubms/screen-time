...
# Pair device (calls redeemPairingCode — set SCREEN_TIME_REDEEM_URL)
poetry run screen-time-agent pair --code ABC123
...
| Variable | Purpose |
|----------|---------|
| `SCREEN_TIME_REDEEM_URL` | Cloud Function URL for pairing |
